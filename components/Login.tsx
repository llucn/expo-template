  ...
  render(): React.ReactNode {
    ...
    return (
      <ViewWrapper topBackgroundColor="#000000" statusBarStyle="light-content">
        <TopNavigationBarLogin title={afterReset ? 'Your new password has been activated' : 'Log in to Expo Template'} backText="" backOnPress={afterReset ? undefined : undefined} subTitle={this.helperText} />
